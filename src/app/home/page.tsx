  ...
  return (
    <div className="flex justify-center items-center w-screen h-screen">
      <div className="text-white font-karla bg-neutral-800 flex justify-center flex-col items-center gap-3 py-40 p-8 rounded-lg shadow-xl">
        ...
        <input className="border-solid border-2 border-black rounded-md p-1 w-96" type="text" name="login" placeholder="login"/>
        <label htmlFor="senha" className="text-xl">Senha</label>
        <input className="border-solid border-2 border-black rounded-md p-1 w-96" type="password" name="senha" placeholder="senha"/>
